...
- [ ] Extended and condensed papers state the same central thesis in different levels of detail.
- [ ] Every main-text claim appears in `docs/research/11_final_claim_inventory.md`.
- [ ] No main-text claim relies on `/tmp`, scratch-only, or superseded roots.
- [ ] `H5` is described only as the unsupported Phase 3 `split_k` result.
- [ ] `R6` is described as a bounded mainline improvement, not as a universal win.
...
- [ ] Appendix contains chronology and provenance, not new claims.
- [ ] `paper/main.tex` and `paper/main_condensed.tex` both compile cleanly with bibliography.
