...
| Introduction | `docs/research/01_research_program.md`, `docs/research/11_final_claim_inventory.md` | `artifacts/analysis/final_paper_20260330/final_claim_table.csv` | `C-FINAL-HEADLINE`, `C-FINAL-H1`, `C-FINAL-H4`, `C-FINAL-CLOSEOUT` | `T1` |
| Background and Problem Setting | `docs/research/02_tuning_theory_and_knob_space.md`, `docs/research/03_bottleneck_taxonomy.md`, `docs/research/05_workload_matrix_and_case_studies.md` | final claim bundle and final figure map | `C-FINAL-H1`, `C-FINAL-H3` | `T2`, `T3`, Figure 1 |
...
| Related Work | project framing plus standard literature | bibliography | none directly | none |
