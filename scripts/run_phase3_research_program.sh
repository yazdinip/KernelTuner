...
PROGRAM_ID="${PROGRAM_ID:-phase3_research_program_$(date -u +%Y%m%dT%H%M%SZ)}"
...
cleanup_phase3_artifacts() {
  local targets=(
    ...
    "artifacts/gemm_v3_reportable"
    "artifacts/gemm_v3_ablation_parent"
    "artifacts/gemm_v3_ablation_frontier"
    "artifacts/gemm_v3_ablation_profiled"
...
echo "baseline_phase2_bundle=${REPO_ROOT}/artifacts/analysis/phase2_20260327"
nvidia-smi --query-gpu=name,driver_version --format=csv,noheader
python3 --version
ncu --version | head -n 1
finish_step

start_step "cleanup_phase3_artifacts"
cleanup_phase3_artifacts
finish_step

start_step "phase3_preflight"
