...
def test_canonical_shape_id_is_deterministic():
    payload = {"dimensions": {"m": 128, "n": 128, "k": 128}, "dtype": "fp16", "layout": "row_major"}
...
def test_layernorm_shape_id_is_deterministic():
    payload = {"dimensions": {"rows": 128, "hidden": 768}, "dtype": "fp16", "layout": "row_major"}
    assert canonical_shape_id("layernorm", payload) == "layernorm_rows128_hidden768_fp16_rowmajor"
